...
public class VolumeFragment extends BaseFragment implements ItemClickListener, AddFavoriteListener {
	...
	public void onSearchedCoin(EventBusListener.SearchCoin event) {
		if(event.tab != Constant.TAB_VOLUME) return;
	...
	public void onFragmentReady(View view) {
		...
		if (allCoinAdapter == null) {
			allCoinAdapter = new AllCoinAdapter(allCoins, false,this, this);
		}
		onUpdatedTheme();
