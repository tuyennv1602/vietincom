...
public class FavoriteFragment extends BaseFragment implements ItemClickListener, AddFavoriteListener {
	...
	public static FavoriteFragment newInstance(double rate, int lastRank) {
		FavoriteFragment favoriteFragment = new FavoriteFragment();
		favoriteFragment.rate = rate;
	...
	public void onItemClicked(int position) {
		pushFragment(CoinDetailFragment.newInstance(allCoins.get(position), rate), R.anim.zoom_in, R.anim.zoom_out);
	}
